...
const Demo1 = loadable(() => import('@/views/Test/Demo1'))
...
const routes = [
    ...
    { path: '/demo/demo1', exact: true, name: 'Demo1', component: Demo1 },
    { path: '/demo/demo1/detail', exact: true, name: 'Demo1', component: Detail },
]
